...
export const Footer: FC = () => {
  return (
    <div className="flex flex-col text-center text-xs text-zinc-700 gap-1 items-center">
      <div className="text-zinc-400">Heurist 🤝 Lepton</div>
      <div className="flex gap-2 justify-center">
        <div>
          <Link
            className="flex-nowrap font-medium text-nowrap text-blue-500 gap-1 inline-flex items-center"
      ...
      <div className="flex flex-wrap mt-2 text-zinc-400 gap-x-4 gap-y-2 items-center justify-center">
        <Link
